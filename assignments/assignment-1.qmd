...
### TASK-1 : Video Reviwe : **{gt} Table Battles \|\| Eurovision \|\| RStudio ( Posit PBCV)**
...
-   Jesse said that he wanted to use the flags and codes of the country and that they were all ready on the Liam D. Bailey site and that he spent 3 or 4 hours trying to do this. This part was a bit challenging.
    (It is necessary to have the files ready, then use the text conversion and then other image functions.)
...
-   *`degisken <- 42
    character <- "Merhaba, Dünya!"`

    Değişken ve karakter türünü tek parantez içinde ekrana verdirme:
    `cat("Değişken: ", degisken, " Karakter: ", character, "\n")`*
...
-   \# NA'ları 0 ile doldur
    na_example_filled \<- ifelse(is.na(na_example), 0, na_example)
